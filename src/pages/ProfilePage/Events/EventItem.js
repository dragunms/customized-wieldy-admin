            ...
            <div className='gx-media-body gx-featured-content'>
                ...
                <div className='gx-featured-content-right gx-profile-content-right'>
                    <h2 className='gx-text-primary gx-mb-1'>
                        ...
                        <span className='gx-d-inline-flex gx-vertical-align-middle'>{date}</span>
                    </h2>
                    <p className='gx-text-primary gx-text-truncate gx-mt-sm-auto gx-mb-0 gx-pointer'>
                        Check in detail
                        <i className='icon icon-long-arrow-right gx-fs-xxl gx-ml-1 gx-ml-sm-2 gx-d-inline-flex gx-vertical-align-middle' />
                    </p>
                </div>
            </div>
        </div>
